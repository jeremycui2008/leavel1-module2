...
class dueling_buttons(tk.Tk):
    ...
    #  look at the example photo for reference.
        self.button_left = tk.Button(self, text='Click me!', fg='blue',
                                font=('courier new', 16, 'bold'), command=self.left_button_pressed)
        self.button_left.place(relx=0.1, rely=0.5, relwidth=0.8, relheight=0.2)
    ...
    def left_button_pressed(self):
        self.button_right.place(LEFT_SMALL)
        self.button_left.place(RIGHT_BIG)
